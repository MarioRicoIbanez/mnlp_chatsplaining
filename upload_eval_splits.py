...
def main():
    ...
    if not hf_token:
        logger.error("Please set HF_TOKEN environment variable with your Hugging Face token")
    ...
    try:
        ...
        processor.push_to_hub(
            repo_name="RikoteMaster/sciq_treated_epfl_mcqa",
            token=hf_token
        )
        ...
        logger.info("")
        logger.info("🔗 View at: https://huggingface.co/datasets/RikoteMaster/sciq_treated_epfl_mcqa")
